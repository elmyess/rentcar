...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        $reservation->car_id = $input['car_id'];
        $reservation->full_name = $input['full_name'];
        $reservation->email = $input['email'];
        $reservation->phone = $input['phone'];
        $reservation->pickup_location = $input['pickup_location'];
        $reservation->pickup_date = $input['pickup_date'];
        $reservation->return_date = $input['return_date'];
